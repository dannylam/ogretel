...
public class IntegerToRoomMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<Integer,Room> {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.INTEGER_TO_ROOM_MAP;
	}
	...
	public Room getTypedValue() {
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.INTEGER_TO_ROOM_MAP__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public void setTypedValue(Room newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.INTEGER_TO_ROOM_MAP__VALUE, oldValue, value));
	}
