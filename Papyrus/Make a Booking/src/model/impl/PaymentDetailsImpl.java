 ...
 * <ul>
 *   <li>{@link model.impl.PaymentDetailsImpl#getCcNr <em>Cc Nr</em>}</li>
 *   <li>{@link model.impl.PaymentDetailsImpl#getCcV <em>Cc V</em>}</li>
 *   <li>{@link model.impl.PaymentDetailsImpl#getExpMonth <em>Exp Month</em>}</li>
 *   <li>{@link model.impl.PaymentDetailsImpl#getExpYear <em>Exp Year</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.PAYMENT_DETAILS__EXP_MONTH:
				return new Integer(getExpMonth());
			case ModelPackage.PAYMENT_DETAILS__EXP_YEAR:
				return new Integer(getExpYear());
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ModelPackage.PAYMENT_DETAILS__CC_V:
				...
				return;
			case ModelPackage.PAYMENT_DETAILS__EXP_MONTH:
				setExpMonth(((Integer)newValue).intValue());
				return;
			case ModelPackage.PAYMENT_DETAILS__EXP_YEAR:
				setExpYear(((Integer)newValue).intValue());
				return;
		}
