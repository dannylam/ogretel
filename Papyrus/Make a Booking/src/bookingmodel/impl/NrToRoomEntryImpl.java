 ...
 * <!-- begin-user-doc -->
 * An implementation of the maintenancemodel object '<em><b>Nr To Room Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class NrToRoomEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,Integer> {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.NR_TO_ROOM_ENTRY;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.NR_TO_ROOM_ENTRY__KEY, oldKey, key));
	}
	...
	public void setTypedValue(Integer newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.NR_TO_ROOM_ENTRY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.NR_TO_ROOM_ENTRY__KEY:
				return getTypedKey();
			case ModelPackage.NR_TO_ROOM_ENTRY__VALUE:
