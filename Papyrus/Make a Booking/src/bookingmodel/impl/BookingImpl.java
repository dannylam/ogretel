 ...
 * <li>{@link bookingmodel.impl.BookingImpl#getServiceNotes <em>Service Notes
 * </em>}</li>
 * <li>{@link bookingmodel.impl.BookingImpl#getNrOfGuests <em>Nr Of Guests</em>}
 * </li>
 ...
 * <li>{@link bookingmodel.impl.BookingImpl#getRoomIDToGuestMap <em>Room ID To
 * Guest Map</em>}</li>
 * <li>{@link bookingmodel.impl.BookingImpl#getRoomTypeToRoomIDMap <em>Room Type
 * To Room ID Map</em>}</li>
 * <li>{@link bookingmodel.impl.BookingImpl#getPaymentMethod <em>Payment Method
 * </em>}</li>
 * <li>{@link bookingmodel.impl.BookingImpl#getExtraToIsPayedMap <em>Extra To Is
 * Payed Map</em>}</li>
 * </ul>
 * </p>
 *
...
public class BookingImpl extends MinimalEObjectImpl.Container implements
		Booking {
	/**
	 * The default value of the '{@link #getBookingRef() <em>Booking Ref</em>}'
	...
	/**
	 * The cached value of the '{@link #getBookingRef() <em>Booking Ref</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getBookingRef()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getServiceNotes()
	 * <em>Service Notes</em>}' attribute list. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getServiceNotes()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getNrOfGuests() <em>Nr Of Guests</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getNrOfGuests()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getNrOfGuests() <em>Nr Of Guests</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getNrOfGuests()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getGuestList() <em>Guest List</em>}'
	...
	/**
	 * The default value of the '{@link #isIsPayed() <em>Is Payed</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIsPayed()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isIsPayed() <em>Is Payed</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIsPayed()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getRoomIDToGuestMap()
	 * <em>Room ID To Guest Map</em>}' map. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getRoomTypeToRoomIDMap()
	 * <em>Room Type To Room ID Map</em>}' map. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getPaymentMethod()
	...
	/**
	 * The cached value of the '{@link #getPaymentMethod()
	 * <em>Payment Method</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getPaymentMethod()
	...
	/**
	 * The cached value of the '{@link #getExtraToIsPayedMap()
	 * <em>Extra To Is Payed Map</em>}' map. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * TODO: Javadoc <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated NOT
	 */
	public BookingImpl(int nrOfGuests, String startDate, String endDate,
			List<String> roomTypes, List<String> extras) {
	...
	public void setBookingRef(String newBookingRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BookingmodelPackage.BOOKING__BOOKING_REF, oldBookingRef,
					bookingRef));
	}
	...
	public void setStartDate(String newStartDate) {
		if (!(newStartDate.equals(null))) {
			...
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET,
						BookingmodelPackage.BOOKING__START_DATE, oldStartDate,
						startDate));
		}
	}
	...
	public void setEndDate(String newEndDate) {
		if (!(newEndDate.equals(null))) {
			...
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET,
						BookingmodelPackage.BOOKING__END_DATE, oldEndDate,
						endDate));
		}
	}
	...
	public EList<String> getServiceNotes() {
		if (serviceNotes == null) {
			serviceNotes = new EDataTypeUniqueEList<String>(String.class, this,
					BookingmodelPackage.BOOKING__SERVICE_NOTES);
		}
		return serviceNotes;
	}
	...
	public void setNrOfGuests(int newNrOfGuests) {
		if (!(newNrOfGuests != 0)) {
			...
			if (eNotificationRequired())
				eNotify(new ENotificationImpl(this, Notification.SET,
						BookingmodelPackage.BOOKING__NR_OF_GUESTS,
						oldNrOfGuests, nrOfGuests));
		}
	}
			...
			if (customer != oldCustomer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							BookingmodelPackage.BOOKING__CUSTOMER, oldCustomer,
							customer));
			}
		}
		return customer;
	...
	public EList<Guest> getGuestList() {
		if (guestList == null) {
			guestList = new EObjectResolvingEList<Guest>(Guest.class, this,
					BookingmodelPackage.BOOKING__GUEST_LIST);
		}
		return guestList;
	}
	...
	public void setIsPayed(boolean newIsPayed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BookingmodelPackage.BOOKING__IS_PAYED, oldIsPayed, isPayed));
	}
	...
	public EMap<Integer, String> getRoomIDToGuestMap() {
		if (roomIDToGuestMap == null) {
			roomIDToGuestMap = new EcoreEMap<Integer, String>(
					BookingmodelPackage.Literals.ROOM_TO_GUEST_ID_ENTRY,
					RoomToGuestIDEntryImpl.class, this,
					BookingmodelPackage.BOOKING__ROOM_ID_TO_GUEST_MAP);
		}
	...
	public EMap<String, Integer> getRoomTypeToRoomIDMap() {
		if (roomTypeToRoomIDMap == null) {
			roomTypeToRoomIDMap = new EcoreEMap<String, Integer>(
					BookingmodelPackage.Literals.ROOM_TYPE_TO_ROOM_ID_ENTRY,
					RoomTypeToRoomIDEntryImpl.class, this,
					BookingmodelPackage.BOOKING__ROOM_TYPE_TO_ROOM_ID_MAP);
		}
	...
	public void setPaymentMethod(PaymentMethod newPaymentMethod) {
		...
		paymentMethod = newPaymentMethod == null ? PAYMENT_METHOD_EDEFAULT
				: newPaymentMethod;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BookingmodelPackage.BOOKING__PAYMENT_METHOD,
	...
	public EMap<String, Boolean> getExtraToIsPayedMap() {
		if (extraToIsPayedMap == null) {
			extraToIsPayedMap = new EcoreEMap<String, Boolean>(
					BookingmodelPackage.Literals.EXTRA_TO_IS_PAYED_ENTRY,
					ExtraToIsPayedEntryImpl.class, this,
					BookingmodelPackage.BOOKING__EXTRA_TO_IS_PAYED_MAP);
		}
		return extraToIsPayedMap;
	}

	/**
	 * Checks if all the rooms in the booking has a responsible guest. If so,
	...
	public boolean checkedInAllGuest() {
		...
		// TODO: L拡ga till try-catch och f系ga exceptions p� ett l確pligt s閣t.
	}

	/**
	 * Checks if at least one room in the booking has a responsible guest. If
	...
	/**
	 * Sets a guest its responsibility to a specific room, by connecting their
	 * email address to a roomID. TODO: check if correct
	 * 
	 * @param roomID
	 *            , guestEmail
	 * @generated NOT
	...
	/**
	 * Sets a guest its responsibility to all its booked rooms, by connecting
	 * their email address to a set of room IDs. TODO: check if correct
	 * 
	 * @param guestEmail
	 * @generated NOT
	 */
	...
	/**
	 * Returns the number of specific booked rooms. TODO: check if its correct
	 * 
	 * @generated NOT
	 */
	...
	public int setRoomIDs(List<Integer> roomIDs) {
		...
		for (int i = 0; i < roomIDs.size(); i++) {
			this.roomIDToGuestMap.put(roomIDs.get(i), roomIDToGuestMap.get(i)
					.getValue());
		}
		return result;
	...
	/**
	 * Sets all payed extras into a list, where the results indicate how it
	 * went.
	 * 
	 * @generated NOT
	 */
	...
	/**
	 * Sets all the roomtypes into a list, where the results indicate how it
	 * went.
	 * 
	 * @generated NOT
	 */
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case BookingmodelPackage.BOOKING__ROOM_ID_TO_GUEST_MAP:
			return ((InternalEList<?>) getRoomIDToGuestMap()).basicRemove(
					otherEnd, msgs);
		case BookingmodelPackage.BOOKING__ROOM_TYPE_TO_ROOM_ID_MAP:
			return ((InternalEList<?>) getRoomTypeToRoomIDMap()).basicRemove(
					otherEnd, msgs);
		case BookingmodelPackage.BOOKING__EXTRA_TO_IS_PAYED_MAP:
			return ((InternalEList<?>) getExtraToIsPayedMap()).basicRemove(
					otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case BookingmodelPackage.BOOKING__ROOM_ID_TO_GUEST_MAP:
			if (coreType)
				return getRoomIDToGuestMap();
			else
				return getRoomIDToGuestMap().map();
		case BookingmodelPackage.BOOKING__ROOM_TYPE_TO_ROOM_ID_MAP:
			if (coreType)
				return getRoomTypeToRoomIDMap();
			else
				return getRoomTypeToRoomIDMap().map();
		case BookingmodelPackage.BOOKING__PAYMENT_METHOD:
			return getPaymentMethod();
		case BookingmodelPackage.BOOKING__EXTRA_TO_IS_PAYED_MAP:
			if (coreType)
				return getExtraToIsPayedMap();
			else
				return getExtraToIsPayedMap().map();
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case BookingmodelPackage.BOOKING__ROOM_ID_TO_GUEST_MAP:
			...
			return;
		case BookingmodelPackage.BOOKING__ROOM_TYPE_TO_ROOM_ID_MAP:
			((EStructuralFeature.Setting) getRoomTypeToRoomIDMap())
					.set(newValue);
			return;
		case BookingmodelPackage.BOOKING__PAYMENT_METHOD:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case BookingmodelPackage.BOOKING__BOOKING_REF:
			return BOOKING_REF_EDEFAULT == null ? bookingRef != null
					: !BOOKING_REF_EDEFAULT.equals(bookingRef);
		case BookingmodelPackage.BOOKING__START_DATE:
		...
		case BookingmodelPackage.BOOKING__ROOM_TYPE_TO_ROOM_ID_MAP:
			return roomTypeToRoomIDMap != null
					&& !roomTypeToRoomIDMap.isEmpty();
		case BookingmodelPackage.BOOKING__PAYMENT_METHOD:
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case BookingmodelPackage.BOOKING___SET_RESPONSIBLE_GUEST__INT_STRING:
			return setResponsibleGuest((Integer) arguments.get(0),
