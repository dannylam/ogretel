...
public class bookingRefToBookingEntryImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,Booking> {
	 ...
	 * @generated
	 */
	public Booking basicGetTypedValue() {
		return value;
	}
	 ...
	 * @generated
	 */
	public void setTypedValue(Booking newValue) {
	 ...
	 * @generated
	 */
	public Booking setValue(Booking value) {
		Booking oldValue = getValue();
		setTypedValue(value);
		return oldValue;
	}
	...
	public EMap<String, Booking> getEMap() {
